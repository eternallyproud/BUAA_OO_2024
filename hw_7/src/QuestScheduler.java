...
public class QuestScheduler implements Runnable {
                ...
                if (isOver()) {
                    ...
                    if (undoneTask.isEmpty()) {
                        ...
                        if (reset instanceof DoubleCarReset) {
                            ...
                            Elevator elevator = new Elevator(doubleCarReset.getElevatorId(),
                                    questTable, undoneTask, doubleCarReset);
    ...
    private boolean allocate(Quest quest) {
        ...
        if (!allocated.isResetting()) {
            TimableOutput.println("RECEIVE-" + quest.getPersonId() +
                    "-" + allocated.getId() + allocated.getStr());
        }
